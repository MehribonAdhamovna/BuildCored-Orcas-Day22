...
COMPONENT_PROMPT = (
    "Identify all electronic components in this schematic. "
    "List them using the format: [Quantity] x [Component Name]. "
    "Look specifically for resistors, capacitors, ICs, and ground symbols. "
    "Keep it brief. If no components are found, reply with 'No components detected'."
)
...
#
WIRING_ERROR_PROMPT = (
    "Analyze the connections in this schematic for electrical errors. "
    "Check for: 1. Unconnected wires (floating pins), 2. Missing ground symbols, "
    "3. Short circuits between power and ground. "
    "If the circuit looks valid, say 'No obvious errors.' "
    "Otherwise, list the top 2 concerns."
)
